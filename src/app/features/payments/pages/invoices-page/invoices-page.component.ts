 ...
 */
@Component({
  selector: 'edushift-invoices-page',
  standalone: true,
      ...
      @if (loading()) {
        ...
        <ul class="space-y-3">
          @for (i of items(); track i.publicUuid) {
            <li>
              <a [routerLink]="['/payments/invoices', i.publicUuid]"
                 class="block rounded-2xl bg-white dark:bg-slate-900 shadow
                ...
                <div class="flex items-start justify-between gap-3">
                  ...
                  <div class="text-right">
                    ...
                    <span class="mt-1 inline-flex items-center rounded-full px-2 py-0.5
