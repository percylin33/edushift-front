  ...
  template: `
    <section class="mx-auto max-w-4xl px-4 py-8 sm:py-10">
      <header class="mb-6 flex items-center justify-between gap-3">
        <div>
          <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Anuncios</h1>
      ...
      @if (loading()) {
        ...
        >
          <p class="text-sm text-slate-500 dark:text-slate-400">Aún no hay anuncios publicados.</p>
        </div>
      } @else {
        <ul class="space-y-3">
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div class="min-w-0 flex-1">
                  ...
                  >
                    <span
                      class="inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 dark:bg-slate-800"
                    >
                      {{ a.audienceType }}
                    </span>
                    <span>·</span>
                  ...
                  <div
                    class="prose prose-sm mt-3 line-clamp-3 max-w-none dark:prose-invert"
                    [innerHTML]="safeBody(a.bodyHtml)"
                  ></div>
                </div>
              </div>
            </li>
