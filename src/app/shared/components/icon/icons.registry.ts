/**
 * Inline SVG registry. Paths are Lucide-style (24x24, stroke-based) which lets
 * us color icons with `currentColor` and resize them via the `size` input.
 *
 * Add new icons here only. Keep names kebab-case.
 */
export const ICONS = {
  ...
  'graduation-cap':
    '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1 3 2 6 2s6-1 6-2v-5"/>',
  'calendar-check':
    '<path d="M21 14V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h9"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><path d="m16 20 2 2 4-4"/>',
  ...
  /* FE-7a.3 — LMS materials */
  image:
    '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',
  'trending-up':
    '<polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/>',
  /* FE-7b.1 — LMS quiz builder */
  ...
  // Sprint 11 / FE-11.3 — admin power tools sidebar entry.
  'shield-check':
    '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',
  // Sprint 11 / FE-11.4 — Google "G" mark for the Sign-in button.
  // Filled (not stroke) so the brand colors render correctly. Host styles
  // override stroke-width/colors on the wrapper SVG.
  'google-g':
    '<path fill="#4285F4" d="M21.35 11.1H12v3.8h5.35c-.5 2.5-2.6 4.1-5.35 4.1a6 6 0 1 1 0-12 5.5 5.5 0 0 1 3.85 1.5l2.65-2.6A9.4 9.4 0 0 0 12 3a9 9 0 1 0 9 9c0-.65-.05-1.25-.15-1.9z"/>',
} as const;
